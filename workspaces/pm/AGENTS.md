...
- For cross-team coordination:
  - Post questions/decisions for specific roles in their owner channel and include `Task` and explicit ask.
  - Keep all coordination non-blocking and summary-ready for execution teams.
